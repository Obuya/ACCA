    ...
    <div class="container" id="grid">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-4 col-lg-5 col-xl-5" id="left">
                ...
                <div class="media" id="crurrentSong"><img id="bigImg" class="mr-3" src={props.location.roomData.backgroundImg}/>
                    <div class="media-body" id="groupMedia">
                        <h5>{props.location.roomData.roomName}</h5>
                        <p id="desk">Lorem ipsum dolor sit amet, consectetur adipiscing elit.&nbsp;</p>
                        <p id="genreTag" class="tags">{props.location.roomData.tag}</p>
                        <p id="numberTag" class="tags">{props.location.roomData.numOfppl}/{props.location.roomData.roomSize}</p>
                    </div>
                </div>
                <div class="disappear">
                    <h1>Song Title</h1>
